...
public class Rechnungdrucken extends JDialog {
  ...
  public Rechnungdrucken(JFrame owner, boolean modal, Rechnung r, boolean show) { 
    ...
    pRechnung.setBounds(11, 14, 590, 755);
    ...
    tGeraeteScrollPane.setBounds(21, 282, 564, 374);
    ...
    taRechnungsdetailsScrollPane.setBounds(21, 218, 560, 52);
    ...
    loadTabelleGeraet(r.getMietvertraege(), r.getMietvertraege().get(0).getKunde().getMitgliedid());
